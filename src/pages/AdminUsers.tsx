...
function AdminUsers(){
  ...
  return <div>
    <PageHead title={t('users.title')} subtitle={t('users.accountsCount',{n:users.length})} actions={<Btn onClick={()=>setAdd(true)}><Icon name="plus" className="w-4 h-4"/>{t('users.addUser')}</Btn>}/>
